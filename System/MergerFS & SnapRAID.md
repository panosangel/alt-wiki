...
# MergerFS union
/mnt/disk*                                   /mnt/storage  fuse.mergerfs cache.files=partial,moveonenospc=true,dropcacheonclose=false,func.getattr=newest,minfreespace=100G,inodecalc=path-hash,fsname=mergerfs 0 0
