...
# MergerFS union
/mnt/disk*                                   /mnt/storage  fuse.mergerfs allow_other,use_ino,cache.files=partial,func.getattr=newest,dropcacheonclose=false,moveonenospc=true,minfreespace=100G,inodecalc=path-hash,fsname=mergerfs 0 0
